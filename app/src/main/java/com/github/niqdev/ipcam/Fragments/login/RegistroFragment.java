...
public class RegistroFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if(container!=null){
            View rootView = inflater.inflate(R.layout.registro_layout_1,container,false);

            usuario = (EditText)rootView.findViewById(R.id.Usuario_registro_1);
            password = (EditText)rootView.findViewById(R.id.password_registro_1);
            passworda = (EditText)rootView.findViewById(R.id.passworda_registro_1);
            cancelar = (Button)rootView.findViewById(R.id.cancelar_1);
            aceptar = (Button)rootView.findViewById(R.id.aceptar_1);
    ...
    private void hacerRegistro(){
        ...
        if(! (Usuario.equals("") && Password.equals("") && PasswordA.equals(""))) {
